...
var TodoService = (function () {
    ...
    TodoService.prototype.saveTodo = function (todo) {
        ...
        return this._http.post('/api/v1/todo', JSON.stringify(todo), { headers: headers }).map(function (res) {
            return res.json();
        });
    };
    TodoService.prototype.updateTodo = function (todo) {
        var headers = new http_1.Headers();
        headers.append('content-type', 'application/json');
        return this._http.put('/api/v1/todo/' + todo._id, JSON.stringify(todo), { headers: headers }).map(function (res) {
            return res.json();
        });
    };
